...
public class pandafact implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        //https://some-random-api.ml/facts/panda
        if(args.isEmpty()) {
            try {
                URL web = new URL("https://some-random-api.ml/facts/panda");
    ...
    public String getHelp() {
        return "Gives you a random panda fact\n" +
                "Usage: `a!pandafact`";
    }
