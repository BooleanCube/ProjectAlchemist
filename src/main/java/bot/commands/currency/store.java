    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        if(args.isEmpty()) {
            ...
            e.appendDescription("-**creditcard**: **[PRICE = 200 gold]** Expands bank space for gold! Note: This item doesn't go into your inventory\n" +
                    "-**lock** (work in progress): **[PRICE = 300 gold]** Adds a lock for your chest such that the next person that tries to steal from you will not succeed and pay 50 gold as a price\n");
